...
Documentation of the PCMDI Metrics Package (PMP)
=================================================

The PCMDI metrics package is used to objectively compare results from Earth System Models with observations.  
